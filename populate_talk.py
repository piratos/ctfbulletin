...
def populate():
    ...
    challenge = add_challenge('decrypt this too', crypto_cat)
    ...
    challenge2 = add_challenge('deceifer this too', crypto_cat2)
    ...
    challenge3 = add_challenge('crack me too', crypto_cat3)
